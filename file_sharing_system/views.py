...
from .forms import (AddDirectoryForm, AddFileForm, DeleteDirectoryForm,
                    DeleteFileForm, DirectoryForm, DriveForm, EditFileForm,
                    RenameForm)
from .models import Directory, Drive, File
from .serializers import DirectorySerializer, DriveSerializer, FileSerializer
...
def drive_content(request, drive_id):
    ...
    if user.is_superuser or user == drive.owner:
        ...
        if request.user.is_authenticated and hidden_public_directories.exists():
            ...
            # Combine directories based on access levels
    ...
    return render(
        request,
        "file_sharing_system/drive_content.html",
        {
            "drive_id": drive_id,
            "drive": drive,
...
def directory_content(request, directory_id):
    ...
    return render(
        request,
        "file_sharing_system/directory_content.html",
        {
...
def file_content(request, file_id):
    ...
    return render(
        request,
        "file_sharing_system/file_content.html",
        {"file_id": file_id, "file": file, "parent_directory_id": parent_directory.id},
    )
...
def rename_drive(request, drive_id):
    ...
    return render(request, "file_sharing_system/rename_drive.html", {"form": form, "drive": drive})
...
def rename_directory(request, directory_id):
    ...
    return render(
        request,
        "file_sharing_system/rename_directory.html",
...
def edit_file(request, file_id):
    ...
    return render(request, "file_sharing_system/edit_file.html", {"form": form, "file": file})
...
def add_directory(request, drive_id):
    ...
    return render(
        request,
        "file_sharing_system/add_directory.html",
        {"form": form, "drive": drive},
    )
...
def add_file(request, drive_id, directory_id=None):
    ...
    return render(
        request,
        "file_sharing_system/add_file.html",
        {"form": form, "drive": drive, "directory": directory},
    )
...
def edit_directory(request, drive_id, directory_id):
    ...
    return render(
        request,
        "file_sharing_system/edit_directory.html",
        {"form": form, "directory": directory},
    )
